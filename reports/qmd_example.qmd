...
Suppose we were interested in looking in more closely at the province with the highest spread (in terms of standard deviation) of horse populations. We present the standard deviations in @tbl-horse.
...
Additionally, note that in @tbl-horse we consider the sample standard deviation of the number of horses during the same time span as @fig-horse_pops_plot.
...
In @fig-horse_pop_plot_largest_sd we zoom in and look at the province of `r horses_sd_table$Province[1]`, which had the largest spread of values in terms of standard deviation.
